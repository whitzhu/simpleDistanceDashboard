...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LocationForm = __webpack_require__(1);

	var _LocationForm2 = _interopRequireDefault(_LocationForm);

	var _ResultsList = __webpack_require__(159);

	var _ResultsList2 = _interopRequireDefault(_ResultsList);

	var _ResultsEntry = __webpack_require__(160);

	var _ResultsEntry2 = _interopRequireDefault(_ResultsEntry);

	var _searchDistance = __webpack_require__(161);

	var _searchDistance2 = _interopRequireDefault(_searchDistance);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationForm = function LocationForm(_ref) {
	  var handleInputChange = _ref.handleInputChange,
	      toInputVal = _ref.toInputVal,
	      fromInputVal = _ref.fromInputVal,
	      modeInputVal = _ref.modeInputVal,
	      handleSumbit = _ref.handleSumbit,
	      upDateResults = _ref.upDateResults;
	  return _react2.default.createElement(
	    "form",
	    { onSubmit: function onSubmit(e) {
	        return handleSumbit(e, upDateResults);
	      } },
	    "FROM: ",
	    _react2.default.createElement("input", { type: "text", name: "toInputVal", value: toInputVal, onChange: handleInputChange }),
	    _react2.default.createElement("br", null),
	    "TO:",
	    _react2.default.createElement("input", { type: "text", name: "fromInputVal", value: fromInputVal, onChange: handleInputChange }),
	    _react2.default.createElement("br", null),
	    _react2.default.createElement(
	      "select",
	      { name: "modeInputVal", value: modeInputVal, onChange: handleInputChange },
	      _react2.default.createElement(
	        "option",
	        { value: "Driving" },
	        "Driving"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsList = function ResultsList(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(ResultsEntry, { result: results })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsEntry = function ResultsEntry(_ref) {
...
/***/ function(module, exports) {
	...
	var searchDistance = function searchDistance(options, callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fakedata = __webpack_require__(164);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'handleSumbit',
	    value: function handleSumbit(event, callback) {
	      ...
	      (0, _searchDistance2.default)(options, function (data) {
	        callback(data);
	      });
	    }
	  }, {
	    key: 'upDateResults',
	    value: function upDateResults(val) {
	      this.setState({
	        results: val
	      });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(LocationForm, {
	        ...
	        _react2.default.createElement(ResultsList, { results: this.state.results })
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var fakedata = {
	  ...
	  "duration": "13 mins",
	  "durationValue": 809,
	  "origin": "730 Washington St, San Francisco, CA 94108, USA",
	  "destination": "744 Market St, San Francisco, CA 94102, USA", "mode": "walking",
	  "units": "imperial",
	  "language": "en",
	  "avoid": null,
	  "sensor": false
